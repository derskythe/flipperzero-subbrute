 ...
 *
 * This enumeration defines the possible states of the SubBruteWorker, which is
 * responsible for performing sub-brute forcing tasks.
 *
 * @var SubBruteWorkerStateIDLE The worker is in idle state and not performing
 * any task.
 * @var SubBruteWorkerStateReady The worker is ready to start a new task.
 * @var SubBruteWorkerStateTx The worker is currently performing a sub-brute
 * forcing task.
 * @var SubBruteWorkerStateFinished The worker has finished the sub-brute
 * forcing task.
 */
typedef enum {
...
typedef void (*SubBruteWorkerCallback)(void *context,
                                       SubBruteWorkerState state);

typedef struct SubBruteWorker SubBruteWorker;

/**
 * @brief Allocates memory for a SubBruteWorker object and initializes it with
 * the given radio_device.
 *
 * This function creates a new SubBruteWorker object by allocating memory for it
 * on the heap and initializes it with the provided radio_device. The
 * radio_device parameter must not be NULL.
 *
 * @param[in] radio_device A pointer to a valid SubGhzDevice object.
 * @return A pointer to the newly allocated SubBruteWorker object, or @c NULL if
 ...
 *
 * This function must be called to release the resources allocated to the
 ...
 *
 * This function sets the step value for a given SubBruteWorker instance. The
 * step value determines the increment that will be used for each iteration in
 ...
 *
 * This function initializes a SubBruteWorker instance with default attack
 * settings. The attack_type parameter determines the type of attack to be
 * performed. The step parameter specifies the iteration step to be used during
 * the attack. The protocol parameter provides the necessary protocol
 * information for the attack. The repeats parameter specifies the number of
 * times the attack should be repeated.
 *
 ...
 * @param protocol A pointer to the SubBruteProtocol structure containing
 ...
 */
bool subbrute_worker_init_default_attack(SubBruteWorker *instance,
 ...
 */
bool subbrute_worker_init_file_attack(SubBruteWorker *instance, uint64_t step,
                                      uint8_t load_index, uint64_t file_key,
                                      SubBruteProtocol *protocol,
                                      uint8_t repeats, bool two_bytes);

/**
 * @brief Start the SubBruteWorker instance.
 *
 * This function starts the SubBruteWorker instance, allowing it to begin its
 * work.
 *
 ...
 *
 * @note Before calling this function, make sure all the necessary inputs and
 * configurations have been set on the SubBruteWorker instance.
 */
 ...
 *
 * This function stops the SubBruteWorker instance by performing necessary
 * clean-up operations. After calling this function, the instance is no longer
 * usable.
 *
...
/**
 * @brief Transmits the current key of the SubBruteWorker instance to another
 * device.
 *
 * This function transmits the current key of the SubBruteWorker instance to
 * another device using the specified step value.
 *
 ...
 */
bool subbrute_worker_transmit_current_key(SubBruteWorker *instance,
                                          uint64_t step);

/**
 * @brief Check if the `SubBruteWorker` instance can transmit manually.
 *
 * This function is used to determine if the `SubBruteWorker` instance is
 * capable of manual transmission.
 *
 * @param instance Pointer to the `SubBruteWorker` instance.
 * @return `true` if the `SubBruteWorker` instance can transmit manually,
 * `false` otherwise.
 */
 ...
 */
void subbrute_worker_set_callback(SubBruteWorker *instance,
 ...
 *
 * This function sets the timeout value for the SubBruteWorker instance. The
 * timeout defines the maximum time allowed for the worker to complete its task
...
/**
 * @brief Retrieves the number of repeated substrings found by the
 * SubBruteWorker instance.
 *
 * This function returns the count of repeated substrings found during the
 * execution of the SubBruteWorker instance.
 *
 * @param instance A pointer to the SubBruteWorker instance.
 ...
 *
 * This function sets the number of repeats for the SubBruteWorker instance. The
 * repeats determines how many times a certain operation should be repeated.
 *
 * @param instance A pointer to the SubBruteWorker instance.
 ...
 *
 * This function returns the value of the te member variable of the
 * SubBruteWorker instance.
 *
 * @param instance A pointer to the SubBruteWorker instance.
 ...
 *
 * This function sets the value of the te member variable for the given
 * SubBruteWorker instance. The te value determines the threshold for the worker
 * to stop processing.
 *
 * @param instance Pointer to the SubBruteWorker instance
 ...
 *
 * This function checks the transmission allowance for the given value based on
 * the state of the SubBruteWorker instance.
 *
 * @param instance A pointer to the SubBruteWorker instance.
