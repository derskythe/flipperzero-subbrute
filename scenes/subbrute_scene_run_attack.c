...
static void subbrute_scene_run_attack_callback(SubBruteCustomEvent event,
                                               void *context) {
  furi_assert(context);
...
static void
subbrute_scene_run_attack_device_state_changed(void *context,
...
bool subbrute_scene_run_attack_on_event(void *context,
  ...
  if (event.type == SceneManagerEventTypeCustom) {
    ...
    if (event.event == SubBruteCustomEventTypeTransmitFinished) {
    ...
    } else if (event.event == SubBruteCustomEventTypeTransmitNotStarted ||
      ...
      // subbrute_attack_view_set_current_step(view,
