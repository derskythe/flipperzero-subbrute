...
static void subbrute_scene_setup_extra_init_var_list(SubBruteState *instance,
                                                     bool on_extra) {
  furi_assert(instance);
  char str[6] = {0};
  VariableItem *item;
  ...
  item = variable_item_list_add(var_list, "TimeDelay", 3,
                                setup_extra_td_callback, instance);
  ...
  if (extra) {
    item = variable_item_list_add(var_list, "Repeats", 3,
                                  setup_extra_rep_callback, instance);
    ...
    if (te != 0) {
      item = variable_item_list_add(var_list, "Te", 3, setup_extra_te_callback,
                                    instance);
  ...
  variable_item_list_set_enter_callback(var_list, setup_extra_enter_callback,
                                        instance);
...
bool subbrute_scene_setup_extra_on_event(void *context,
