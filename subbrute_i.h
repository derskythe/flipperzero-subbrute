...
/**
 * @enum SubBruteView
 * @brief An enumeration representing the different views of the SubBrute
 * application
 *
 * This enumeration represents the possible views that the SubBrute application
 * can have. Each view corresponds to a specific screen or UI element in the
 * application.
 */
typedef enum {
 ...
 *
 * This class contains the various elements and variables necessary for the
 * functioning of a SubBrute application.
 */
struct SubBruteState {
  ...
  SubBruteAttackView
      *view_attack; /**< View for attack and setup current protocol */
 ...
 * The loading popup appears when an action is being performed that may take
 * some time to complete.
 *
 * @param context A pointer to the context object associated with the loading
 * popup.
 * @param show A boolean value indicating whether to display or hide the loading
 * popup.
 */
 ...
 *
 * This function serves as a callback for handling text input in the sub-brute
 * module. It should be registered as a callback function for text input events.
 *
 ...
 *
 * This function is called when a popup window is closed. It can be used to
 * perform any necessary cleanup or additional processing after the popup window
 * is closed.
 *
 * @param context A void pointer to the context data associated with the popup
 * window. It can be used to pass any additional information needed by the
 * callback function.
 *
 * @return void
 */
